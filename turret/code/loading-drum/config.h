...
#define GATE_MOTOR_FORWARD_PIN 5
#define GATE_MOTOR_BACKWARD_PIN 9
...
#define LOADING_DRUM_MOVER_MOTOR_FORWARD_PIN 7
#define LOADING_DRUM_MOVER_MOTOR_BACKWARD_PIN 8
#define LOADING_DRUM_MOVER_MOTOR_FRONT_END_PIN 2
#define LOADING_DRUM_MOVER_MOTOR_BACK_END_PIN 4

#define LOADING_DRUM_ROTATION_MOTOR_FORWARD_PIN 10
#define LOADING_DRUM_ROTATION_MOTOR_BACKWARD_PIN 11
#define LOADING_DRUM_ROTATION_MOTOR_POSITION_PIN A0
#define LOADING_DRUM_ROTATION_SHELL_CHECKER_PIN A1
