...
#ifndef MAX7456_REGISTERS_H_
#define MAX7456_REGISTERS_H_


#include <Arduino.h>


#define ARROW_UP_CHARACTER 0x18
#define ARROW_DOWN_CHARACTER 0x19
#define DRIVER_FRONT_CAMERA 0x1a
#define DRIVER_BACK_CAMERA 0x1b

#define CAMERA_LEFT_CONSTRAIN 0x1c
#define CAMERA_RIGHT_CONSTRAIN 0x1d
#define CAMERA_POINTER 0x1f

/**
 * @typedef charact
 * @brief Represents a character as stored in max7456 character memory.
 */
typedef byte charact[64];
